        ...
        <div class="col-sm-4">
            <div class="page-header float-left">
                <div class="page-title">
                    <h1>Les locataires insolvables</h1>
                </div>
            </div>
        </div>
        <div class="col-sm-8">
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        ...
                        <li class="active">Les locataires insolvables</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    @foreach($building->apartments->chunk(4) as $apartments)
                        <div class="row">
                            @foreach($apartments as $apartment)
                                @if($apartment->getCurrentTenant() && ($apartment->getCurrentTenant()->getUncompletedRents()>0 || $apartment->getCurrentTenant()->getUnpaidRents()>0))
                                    <div class="col-md-4">
